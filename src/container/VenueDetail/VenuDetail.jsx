...
render() {
   ...
   let bgColor = !this.state.favorited ? "#fff" : "#951922"
   let color = !this.state.favorited ? "#951922" : "#fff"  
  ...
  <div className="fl-fl float-fb">
    ...
    <div className="container-fluid cover-bkg" fav id="detail" style={{background: `url(/images/${this.state.venue.imagefile})`}}>
      ...
      <address>
      {this.state.venue.street}<br />
      {this.state.venue.city}, {this.state.venue.state} {this.state.venue.zipcode}<br />
      ...
      <span className="lnr lnr-phone-handset" onClick={event => this.externalClickHandler(event, this.state.venue.website)}></span>
      <span className="lnr lnr-heart" style={{background: bgColor, color: color}} onClick={(action) => this.addToFavoritesHandler(this.state.venue.id)}></span>
      </div>
